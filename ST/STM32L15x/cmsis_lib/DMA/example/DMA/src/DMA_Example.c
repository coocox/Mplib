...
const uint32_t SrcBuffer[BUFFER_SIZE] = { 0x01020304, 0x05060708, 0x090A0B0C,
		...
		0x6D6E6F70, 0x71727374, 0x75767778, 0x797A7B7C, 0x7D7E7F80 };
uint32_t DstBuffer[BUFFER_SIZE];

/* Private function prototypes -----------------------------------------------*/
TestStatus Buffercmp(const uint32_t* pBuffer, uint32_t* pBuffer1,
