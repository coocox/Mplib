...
#ifndef __TMPM341_GPIO_H
#define __TMPM341_GPIO_H
...
#define IS_GPIO_PG_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_2)|| \
                                         ((param) == GPIO_FUNC_REG_3)|| \
                                         ((param) == GPIO_FUNC_REG_4))
...
#define GPIO_PC_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PC_FR3_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PC_FR4_BIT_ALL                      ((uint8_t)0x44)
...
#define GPIO_PE_FR1_BIT_ALL                      ((uint8_t)0x0F)
#define GPIO_PE_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PE_FR3_BIT_ALL                      ((uint8_t)0xFC)
...
#define GPIO_PG_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PG_FR3_BIT_ALL                      ((uint8_t)0xF7)
#define GPIO_PG_FR4_BIT_ALL                      ((uint8_t)0x40)

#define GPIO_PH_OUTPUT_BIT_ALL                   ((uint8_t)0x7F)
#define GPIO_PH_PULLUP_BIT_ALL                   ((uint8_t)0x7F)
#define GPIO_PH_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x7F)
#define GPIO_PH_INPUT_BIT_ALL                    ((uint8_t)0x7F)
#define GPIO_PH_FR1_BIT_ALL                      ((uint8_t)0x60)
#define GPIO_PH_FR2_BIT_ALL                      ((uint8_t)0x1F)
#define GPIO_PH_FR3_BIT_ALL                      ((uint8_t)0x18)
#define GPIO_PH_FR4_BIT_ALL                      ((uint8_t)0x04)

#define GPIO_PI_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0xDF)
#define GPIO_PI_PULLDOWN_BIT_ALL                 ((uint8_t)0x20)
...
#define GPIO_PJ_FR3_BIT_ALL                      ((uint8_t)0xFF)

#define GPIO_PK_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PK_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PK_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PK_FR2_BIT_ALL                      ((uint8_t)0x0A)
