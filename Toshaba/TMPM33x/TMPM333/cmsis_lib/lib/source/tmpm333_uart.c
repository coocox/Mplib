...
#if defined(__TMPM330_UART_H) || defined(__TMPM332_UART_H) || defined(__TMPM333_UART_H)
...
/**
  ...
  *   UART0, UART1, UART2 (for M330 and M333)
  * @retval None
  */
...
#endif                          /* defined(__TMPM330_UART_H) || defined(__TMPM332_UART_H) || defined(__TMPM333_UART_H) */
