...
#ifndef __TMPM332_GPIO_H
#define __TMPM332_GPIO_H
...
#define GPIO_PA_OUTPUT_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PA_PULLUP_BIT_ALL                   ((uint8_t)0x0D)
#define GPIO_PA_PULLDOWN_BIT_ALL                 ((uint8_t)0x02)
#define GPIO_PA_INPUT_BIT_ALL                    ((uint8_t)0x0F)

#define GPIO_PB_OUTPUT_BIT_ALL                   ((uint8_t)0x01)
#define GPIO_PB_PULLUP_BIT_ALL                   ((uint8_t)0x01)
#define GPIO_PB_INPUT_BIT_ALL                    ((uint8_t)0x01)
...
#define GPIO_PF_OUTPUT_BIT_ALL                   ((uint8_t)0x70)
#define GPIO_PF_PULLUP_BIT_ALL                   ((uint8_t)0x70)
#define GPIO_PF_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x70)
#define GPIO_PF_INPUT_BIT_ALL                    ((uint8_t)0x70)

#define GPIO_PG_OUTPUT_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PG_PULLUP_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PG_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x0F)
#define GPIO_PG_INPUT_BIT_ALL                    ((uint8_t)0x0F)

#define GPIO_PH_OUTPUT_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PH_PULLUP_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PH_INPUT_BIT_ALL                    ((uint8_t)0x0F)

#define GPIO_PI_OUTPUT_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PI_INPUT_BIT_ALL                    ((uint8_t)0x3F)

#define GPIO_PJ_OUTPUT_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PJ_PULLUP_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PJ_INPUT_BIT_ALL                    ((uint8_t)0x1F)

#define GPIO_PK_OUTPUT_BIT_ALL                   ((uint8_t)0x03)
#define GPIO_PK_PULLUP_BIT_ALL                   ((uint8_t)0x02)
...
#define IS_GPIO_PF_DATA_BIT(param)      (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6))

#define IS_GPIO_PF_OUTPUT_BIT(param)    (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6)|| \
                                         ((param) == GPIO_PF_OUTPUT_BIT_ALL))

#define IS_GPIO_PF_FR1_BIT(param)       (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6))

#define IS_GPIO_PF_OPEN_DRAIN_BIT(param) (((param) == GPIO_BIT_4)|| \
                                          ((param) == GPIO_BIT_5)|| \
                                          ((param) == GPIO_BIT_6)|| \
                                          ((param) == GPIO_PF_OPEN_DRAIN_BIT_ALL))

#define IS_GPIO_PF_PULLUP_BIT(param)    (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6)|| \
                                         ((param) == GPIO_PF_PULLUP_BIT_ALL))

#define IS_GPIO_PF_INPUT_BIT(param)     (((param) == GPIO_BIT_4)|| \
                                         ((param) == GPIO_BIT_5)|| \
                                         ((param) == GPIO_BIT_6)|| \
