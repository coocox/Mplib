...
#ifndef __TMPM332_UART_H
#define __TMPM332_UART_H
...
/** @defgroup UART_Exported_Constants
  * @{
  */
#if defined(__TMPM330_UART_H) || defined(__TMPM333_UART_H)
...
#define IS_UART_PERIPH(param)       (((param) == UART0) || \
                                     ...
                                     ((param) == UART2))
#else
#if defined(__TMPM332_UART_H)
#define UART0 TSB_SC0
#define UART1 TSB_SC1
#define IS_UART_PERIPH(param)       (((param) == UART0) || \
                                     ((param) == UART1))
#endif                          /* defined(__TMPM332_UART_H) */
#endif                          /* defined(__TMPM330_UART_H) || defined(__TMPM333_UART_H) */
