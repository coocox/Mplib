...
#ifndef __TMPM061_RTC_H
#define __TMPM061_RTC_H
...
#define IS_RTC_FUNC_MODE(param)       (((param) == RTC_CLOCK_MODE) || \
    ...
    typedef enum {
         RTC_ADJUST_1_SEC = 0U, 
         RTC_ADJUST_10_SEC = 1U,
         RTC_ADJUST_20_SEC = 2U, 
         RTC_ADJUST_30_SEC = 3U,
         RTC_ADJUST_1_MIN = 4U
    } RTC_AdjustInterval;
#define IS_RTC_ADJUST_INTERVAL(param)  ((param) <= RTC_ADJUST_1_MIN)
#define IS_RTC_ADJUST_VALUE(param)     ((param) <= 0x1FFU)  
