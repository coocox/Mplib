...
#define MOD1_I2S_SET           ((uint32_t)0x00000080)
#define MOD1_I2S_CLEAR         ((uint32_t)0x0000007F)
...
/**
  ...
  *   For TMPM360£¬TMPM362 and TMPM364: UART0 to UART11.
  *   For TMPM361 and TMPM363: UART0 to UART4.
  * @retval None
  */
...
void UART_SetIdleMode(TSB_SC_TypeDef * UARTx, FunctionalState NewState)
{
    ...
    if (NewState == ENABLE) {
        /* Set SCxMOD1<I2S> to enable UARTx running in IDLE */
        UARTx->MOD1 |= MOD1_I2S_SET;
    } else {
        /* Clear SCxMOD1<I2S> to disable UARTx running in IDLE */
        UARTx->MOD1 &= MOD1_I2S_CLEAR;
    }
}
