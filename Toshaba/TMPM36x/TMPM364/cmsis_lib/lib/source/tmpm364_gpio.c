...
/* Includes ------------------------------------------------------------------*/
#include "tmpm364_gpio.h"

#if defined(__TMPM364_GPIO_H)
...
/**
  ...
  *   GPIO_PM, GPIO_PN, GPIO_PO, GPIO_PP.
...
uint8_t GPIO_ReadDataBit(GPIO_Port GPIO_x, uint8_t Bit_x)
{
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_DATA_BIT(Bit_x));
        Data = (uint8_t) (TSB_PO->DATA);
        break;
    case GPIO_PP:
        /* Check the parameters */
...
/**
  ...
  *   GPIO_PA, GPIO_PB, GPIO_PC, GPIO_PD,
  *   GPIO_PE, GPIO_PF, GPIO_PG, GPIO_PH,
  *   GPIO_PI, GPIO_PL, GPIO_PM, GPIO_PN,
  *   GPIO_PO, GPIO_PP.
...
void GPIO_SetOutput(GPIO_Port GPIO_x, uint8_t Bit_x)
{
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_OUTPUT_BIT(Bit_x));
        tmp = (~Bit_x);
        TSB_PO->FR1 &= tmp;
        TSB_PO->FR2 &= tmp;
        TSB_PO->FR3 &= tmp;
...
void GPIO_SetInput(GPIO_Port GPIO_x, uint8_t Bit_x)
{
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_INPUT_BIT(Bit_x));
        tmp = (~Bit_x);
        TSB_PO->FR1 &= tmp;
        TSB_PO->FR2 &= tmp;
        TSB_PO->FR3 &= tmp;
...
void GPIO_SetPullUp(GPIO_Port GPIO_x, uint8_t Bit_x, FunctionalState NewState)
{
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_PULLUP_BIT(Bit_x));
        if (NewState == ENABLE) {
            TSB_PO->PUP |= Bit_x;
        } else {
            tmp = (~Bit_x);
...
void GPIO_SetOpenDrain(GPIO_Port GPIO_x, uint8_t Bit_x, FunctionalState NewState)
{
    ...
    if (Bit_x == GPIO_BIT_ALL) {
        ...
        case GPIO_PN:
            ...
            break;
        case GPIO_PO:
            Bit_x = GPIO_PO_OPEN_DRAIN_BIT_ALL;
            break;
        case GPIO_PP:
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_OPEN_DRAIN_BIT(Bit_x));
        if (NewState == ENABLE) {
            TSB_PO->OD |= Bit_x;
        } else {
            tmp = (~Bit_x);
...
/**
  ...
  *   GPIO_PA, GPIO_PB, GPIO_PC, GPIO_PD,
  *   GPIO_PE, GPIO_PF, GPIO_PG, GPIO_PH,
  *   GPIO_PI, GPIO_PJ, GPIO_PL, GPIO_PM,
  *   GPIO_PN, GPIO_PO, GPIO_PP.
...
void GPIO_EnableFuncReg(GPIO_Port GPIO_x, uint8_t FuncReg_x, uint8_t Bit_x)
{
    ...
    case GPIO_PO:
        /* Check the parameters */
        assert_param(IS_GPIO_PO_FUNCTION_REG(FuncReg_x));
        switch (FuncReg_x) {
        case GPIO_FUNC_REG_1:
            /* Check the parameters */
            assert_param(IS_GPIO_PO_FR1_BIT(Bit_x));
            TSB_PO->FR1 |= Bit_x;
            break;
        case GPIO_FUNC_REG_2:
            /* Check the parameters */
            assert_param(IS_GPIO_PO_FR2_BIT(Bit_x));
            TSB_PO->FR2 |= Bit_x;
            break;
        case GPIO_FUNC_REG_3:
            /* Check the parameters */
            assert_param(IS_GPIO_PO_FR3_BIT(Bit_x));
            TSB_PO->FR3 |= Bit_x;
            break;
        default:
            /* Do nothing */
