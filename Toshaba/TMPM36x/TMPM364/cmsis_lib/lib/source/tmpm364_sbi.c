...
#define SBI_MST_TRX_MASK                ((uint32_t)0x0000003F)

#define SBICR2_PIN_SET                  ((uint32_t)0x00000010)
#define SBICR2_SBIM_MASK                ((uint32_t)0x000000F3)
#define SBICR2_SBIM_I2C                 ((uint32_t)0x00000008)
#define SBICR2_SBIM_SIO                 ((uint32_t)0x00000004)
#define SBICR2_SWRST_MASK               ((uint32_t)0x000000FC)
...
#define SBISR_STATE_MASK                ((uint32_t)0x0000004E)
#define SBISR_AL_SET                    ((uint32_t)0x00000008)
#define SBISR_AD0_CLEAR                 ((uint32_t)0x000000FD)
...
/**
  ...
  *   TSB_SBI0, TSB_SBI1, TSB_SBI2, TSB_SBI3 or TSB_SBI4 (TSB_SBI4 is for TMPM362/M364 only).
  * @retval None
  */
