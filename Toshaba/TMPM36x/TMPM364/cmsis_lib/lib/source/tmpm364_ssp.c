...
/* Includes ------------------------------------------------------------------*/
#include "tmpm364_ssp.h"

#if defined(__TMPM360_SSP_H) || defined(__TMPM361_SSP_H) || defined(__TMPM362_SSP_H) ||  \
    defined(__TMPM363_SSP_H) || defined(__TMPM364_SSP_H)
...
/**
  * @brief Set the bit rate for transmit and receive.
...
/**
  * @brief Specify the Frame Format of SSP
  * @param  FrameFormat: Frame Format of SSP
  *   This parameter can be one of the following values:
  *    SSP_FORMAT_SPI, SSP_FORMAT_SSI, SSP_FORMAT_MICROWIRE
  * @retval None
  */
...
/**
  * @brief When SSP module is configured as SPI mode, specify the clock polarity in its idle state.
  * @param  ClkPolarity: SPI clock polarity
  *  This parameter can be one of the following values:
  *   SSP_POLARITY_LOW, SSP_POLARITY_HIGH
  * @retval None
  */
...
/**
  * @brief When SSP module is configured as SPI mode, specify its clock phase.
  * @param  ClkPolarity: SPI clock phase
  *  This parameter can be one of the following values:
  *   SSP_PHASE_FIRST_EDGE, SSP_PHASE_SECOND_EDGE
  * @retval None
  */
...
/**
  * @brief Enable/Disable slave mode output
...
/**
  * @brief Set the SSP Master or Slave mode
...
/**
  * @brief Set loop back mode of SSP
...
/**
  * @brief Get the Rx/Tx FIFO state of SSP
...
/**
  * @brief Enable/Disable interrupts of SSP
...
/**
  * @brief Get the Enable/Disable setting for each Interrupt source in SSP module
  * @param None
...
/**
  * @brief Get the raw status of each interrupt source in SSP module
  * @param None
  * @retval data in union SSP_INTState.
...
/**
  * @brief Get the SSP post-enable interrupt status.( after masked)
  * @param None
  * @retval data in union SSP_INTState.
...
/**
  * @brief Clear interrupt flag of SSP by writing '1' to correspond bit.
...
/**
  * @brief Enable/Disable the DMA FIFO for Rx/Tx
...
#endif                          /* __TMPM360_SSP_H || __TMPM361_SSP_H || __TMPM362_SSP_H || __TMPM363_SSP_H || __TMPM364_SSP_H   */
