...
#ifndef __TMPM364_SBI_H
#define __TMPM364_SBI_H
...
#if defined(__TMPM360_SBI_H) || defined(__TMPM361_SBI_H) || defined(__TMPM362_SBI_H) || defined(__TMPM363_SBI_H) || defined(__TMPM364_SBI_H)
...
#define SBISR_LRB_SET ((uint32_t)0x00000001)
#define SBISR_ADO_SET ((uint32_t)0x00000002)
#define SBISR_AAS_SET ((uint32_t)0x00000004)
#define SBISR_AL_SET  ((uint32_t)0x00000008)
#define SBISR_PIN_SET ((uint32_t)0x00000010)
#define SBISR_BB_SET  ((uint32_t)0x00000020)
#define SBISR_TRX_SET ((uint32_t)0x00000040)
#define SBISR_MST_SET ((uint32_t)0x00000080)
...
#if defined(__TMPM364_SBI_H) || defined(__TMPM362_SBI_H) || defined(__TMPM360_SBI_H)
#define SBI_CHANNEL_NUMBER              5
#define IS_SBI_PERIPH(param)      (((param) == TSB_SBI0) || \
                                   ((param) == TSB_SBI1) || \
                                   ((param) == TSB_SBI2) || \
                                   ((param) == TSB_SBI3) || \
                                   ((param) == TSB_SBI4))
#else   /* __TMPM363_SBI_H || __TMPM361_SBI_H */
#define SBI_CHANNEL_NUMBER              4
#define IS_SBI_PERIPH(param)      (((param) == TSB_SBI0) || \
                                   ((param) == TSB_SBI1) || \
                                   ((param) == TSB_SBI2) || \
                                   ((param) == TSB_SBI3))
#endif  /* __TMPM364_SBI_H || __TMPM362_SBI_H || __TMPM360_SBI_H     */
...
#endif    /* __TMPM360_SBI_H || __TMPM361_SBI_H || __TMPM362_SBI_H || __TMPM363_SBI_H || __TMPM364_SBI_H   */

#ifdef __cplusplus
}
#endif                          /* __cplusplus */
#endif                          /* __TMPM364_SBI_H */
