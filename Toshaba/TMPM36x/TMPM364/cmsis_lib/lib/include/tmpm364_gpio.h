...
#ifndef __TMPM364_GPIO_H
#define __TMPM364_GPIO_H
...
#define IS_GPIO_PO_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_1)|| \
                                         ((param) == GPIO_FUNC_REG_2)|| \
                                         ((param) == GPIO_FUNC_REG_3))
...
#define GPIO_PC_FR2_BIT_ALL                      ((uint8_t)0x77)
#define GPIO_PC_FR3_BIT_ALL                      ((uint8_t)0x44)
...
#define GPIO_PD_FR2_BIT_ALL                      ((uint8_t)0xF7)
#define GPIO_PD_FR3_BIT_ALL                      ((uint8_t)0x44)
...
#define GPIO_PE_FR3_BIT_ALL                      ((uint8_t)0xF0)
...
#define GPIO_PG_FR2_BIT_ALL                      ((uint8_t)0xF3)
...
#define GPIO_PH_FR1_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PH_FR2_BIT_ALL                      ((uint8_t)0xFF)

#define GPIO_PI_OUTPUT_BIT_ALL                   ((uint8_t)0x03)
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0x01)
#define GPIO_PI_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x01)
#define GPIO_PI_INPUT_BIT_ALL                    ((uint8_t)0x03)
#define GPIO_PI_FR1_BIT_ALL                      ((uint8_t)0x02)
...
#define GPIO_PL_FR3_BIT_ALL                      ((uint8_t)0x40)
...
#define GPIO_PN_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PN_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PN_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xFF)
#define GPIO_PN_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PN_FR1_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PN_FR2_BIT_ALL                      ((uint8_t)0xCC)
#define GPIO_PN_FR3_BIT_ALL                      ((uint8_t)0xCC)

#define GPIO_PO_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PO_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PO_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xFF)
#define GPIO_PO_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PO_FR1_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PO_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PO_FR3_BIT_ALL                      ((uint8_t)0x44)
...
#define IS_GPIO_PO_DATA_BIT(param)      (((param) == GPIO_BIT_0)|| \
                                         ((param) == GPIO_BIT_1)|| \
                                         ((param) == GPIO_BIT_2)|| \
                                         ((param) == GPIO_BIT_3)|| \
                                         ((param) == GPIO_BIT_4)|| \
...
#define IS_GPIO_PO_OUTPUT_BIT(param)     (((param) & GPIO_PO_OUTPUT_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_OUTPUT_BIT_ALL))))

#define IS_GPIO_PO_FR1_BIT(param)        (((param) & GPIO_PO_FR1_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_FR1_BIT_ALL))))

#define IS_GPIO_PO_FR2_BIT(param)        (((param) & GPIO_PO_FR2_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_FR2_BIT_ALL))))

#define IS_GPIO_PO_FR3_BIT(param)        (((param) & GPIO_PO_FR3_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_FR3_BIT_ALL))))

#define IS_GPIO_PO_OPEN_DRAIN_BIT(param) (((param) & GPIO_PO_OPEN_DRAIN_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_OPEN_DRAIN_BIT_ALL))))

#define IS_GPIO_PO_PULLUP_BIT(param)     (((param) & GPIO_PO_PULLUP_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_PULLUP_BIT_ALL))))

#define IS_GPIO_PO_INPUT_BIT(param)      (((param) & GPIO_PO_INPUT_BIT_ALL)&& \
                                          (!((param) & (~GPIO_PO_INPUT_BIT_ALL))))
