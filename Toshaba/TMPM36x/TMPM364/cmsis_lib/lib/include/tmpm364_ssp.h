...
#ifndef __TMPM364_SSP_H
#define __TMPM364_SSP_H
#ifdef __cplusplus
extern "C" {
#endif
...
#if defined(__TMPM360_SSP_H) || defined(__TMPM361_SSP_H) || defined(__TMPM362_SSP_H) || defined(__TMPM363_SSP_H) || defined(__TMPM364_SSP_H)
...
#define IS_SSP_CLEAR_INT_SRC(param)  (((param) == SSP_INTCFG_RX_OVERRUN) || \
    ...
    typedef union {
        ...
        struct {
            ...
            uint32_t Rx:1;
            uint32_t Tx:1;
            uint32_t Reserverd:28;      /* bit 4 to 31 */
        } Bit;
    } SSP_INTState;
