...
#ifndef __TMPM364_UART_H
#define __TMPM364_UART_H
...
#if defined(__TMPM360_UART_H) || defined(__TMPM361_UART_H) || defined(__TMPM362_UART_H) || defined(__TMPM363_UART_H) || defined(__TMPM364_UART_H)
...
/** @defgroup UART_Exported_Constants
  * @{
  */
#if defined(__TMPM360_UART_H) || defined(__TMPM362_UART_H) || defined(__TMPM364_UART_H)
#define UART0  TSB_SC0
#define UART1  TSB_SC1
#define UART2  TSB_SC2
#define UART3  TSB_SC3
#define UART4  TSB_SC4
#define UART5  TSB_SC5
#define UART6  TSB_SC6
#define UART7  TSB_SC7
#define UART8  TSB_SC8
#define UART9  TSB_SC9
#define UART10 TSB_SC10
#define UART11 TSB_SC11
#define IS_UART_PERIPH(param)       (((param) == UART0)  || \
                                     ...
                                     ((param) == UART11))
#else
#if defined(__TMPM361_UART_H) || defined(__TMPM363_UART_H)
#define UART0 TSB_SC0
#define UART1 TSB_SC1
#define UART2 TSB_SC2
#define UART3 TSB_SC3
...
#define IS_UART_PERIPH(param)       (((param) == UART0) || \
                                     ...
                                     ((param) == UART3) || \
                                     ((param) == UART4))
#endif                          /* defined(__TMPM361_UART_H) || defined(__TMPM363_UART_H) */
#endif                          /* defined(__TMPM360_UART_H) || defined(__TMPM362_UART_H) || defined(__TMPM364_UART_H) */
...
#endif                          /* defined(__TMPM360_UART_H) || defined(__TMPM361_UART_H) || defined(__TMPM362_UART_H) || defined(__TMPM363_UART_H) || defined(__TMPM364_UART_H) */

#ifdef __cplusplus
}
#endif
#endif                          /* __TMPM364_UART_H */
