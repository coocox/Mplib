 ...
 * @brief   The demo functions of CG for the TOSHIBA 'TMPM364' Device Series 
 * @version V0.200
 * @date    2010/07/09
 * 
...
#if defined (__TMPM361_CG_H)||defined(__TMPM362_CG_H)||defined(__TMPM363_CG_H)||defined(__TMPM364_CG_H)
