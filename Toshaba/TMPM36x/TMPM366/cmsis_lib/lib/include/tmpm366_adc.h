...
#ifndef __TMPM366_ADC_H
#define __TMPM366_ADC_H
...
#define IS_ADC_INPUT_CHANNEL(param)     ((param) <= ADC_AN_11)

#define IS_ADC_SCAN_CHANNEL(start, range)       (((start) <= ADC_AN_11) && \
                                                 ((range) >= 1U) && \
                                                (((start) + (range)) <= 12U))
...
#define ADC_REG_SP                      ((uint8_t)0x0C)
...
/**
  ...
  */
    typedef struct {
        uint8_t CmpChannel;     /*!< Select which ADC channel among ADC_AN_00 to ADC_AN_11 will be used */
        uint32_t CmpCnt;        /*!< How many times will valid comparisons be counted, range from 1 to 16 */
        ADC_CmpCondition Condition;     /*!< Conditon to compare AINx with ADCMPy. (x = 00 to 11, y = 0 to 1) */
        ADC_CmpCntMode CntMode; /*!< Mode to compare AINx with ADCMPy. (x = 00 to 11, y = 0 to 1) */
...
#endif                          /* defined(__TMPM366_ADC_H) */

#ifdef __cplusplus
}
#endif
#endif                          /* __TMPM366_ADC_H */
