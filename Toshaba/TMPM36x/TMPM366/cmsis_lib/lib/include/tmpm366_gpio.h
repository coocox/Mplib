...
#ifndef __TMPM366_GPIO_H
#define __TMPM366_GPIO_H
...
#define IS_GPIO_PULLDOWN(param)         (((param) == GPIO_PI))
...
#define IS_GPIO_PD_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_2)|| \
                                         ((param) == GPIO_FUNC_REG_3))
...
#define IS_GPIO_PK_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_2)|| \
                                         ((param) == GPIO_FUNC_REG_3))
...
#define GPIO_PB_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PB_FR3_BIT_ALL                      ((uint8_t)0xFF)

#define GPIO_PC_OUTPUT_BIT_ALL                   ((uint8_t)0x07)
#define GPIO_PC_PULLUP_BIT_ALL                   ((uint8_t)0x07)
#define GPIO_PC_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x07)
#define GPIO_PC_INPUT_BIT_ALL                    ((uint8_t)0x07)
#define GPIO_PC_FR1_BIT_ALL                      ((uint8_t)0x07)
#define GPIO_PC_FR2_BIT_ALL                      ((uint8_t)0x07)
#define GPIO_PC_FR3_BIT_ALL                      ((uint8_t)0x07)
#define GPIO_PC_FR4_BIT_ALL                      ((uint8_t)0x04)
...
#define GPIO_PD_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PD_FR3_BIT_ALL                      ((uint8_t)0x8F)
...
#define GPIO_PE_FR2_BIT_ALL                      ((uint8_t)0xF8)
#define GPIO_PE_FR3_BIT_ALL                      ((uint8_t)0x0C)
#define GPIO_PE_FR4_BIT_ALL                      ((uint8_t)0x04)
#define GPIO_PE_FR5_BIT_ALL                      ((uint8_t)0x0F)
...
#define GPIO_PF_INPUT_BIT_ALL                    ((uint8_t)0xFE)
#define GPIO_PF_FR1_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PF_FR2_BIT_ALL                      ((uint8_t)0x30)
#define GPIO_PF_FR3_BIT_ALL                      ((uint8_t)0x31)

#define GPIO_PG_OUTPUT_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PG_PULLUP_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PG_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x3F)
#define GPIO_PG_INPUT_BIT_ALL                    ((uint8_t)0x3F)
#define GPIO_PG_FR1_BIT_ALL                      ((uint8_t)0x2F)
#define GPIO_PG_FR2_BIT_ALL                      ((uint8_t)0x1F)
#define GPIO_PG_FR3_BIT_ALL                      ((uint8_t)0x1E)
#define GPIO_PG_FR4_BIT_ALL                      ((uint8_t)0x3F)
#define GPIO_PG_FR5_BIT_ALL                      ((uint8_t)0x03)

#define GPIO_PH_OUTPUT_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PH_PULLUP_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PH_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x1F)
#define GPIO_PH_INPUT_BIT_ALL                    ((uint8_t)0x1F)
#define GPIO_PH_FR1_BIT_ALL                      ((uint8_t)0x03)
#define GPIO_PH_FR2_BIT_ALL                      ((uint8_t)0x1C)
#define GPIO_PH_FR3_BIT_ALL                      ((uint8_t)0x1C)
#define GPIO_PH_FR4_BIT_ALL                      ((uint8_t)0x1C)
...
#define GPIO_PI_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x07)
#define GPIO_PI_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PI_FR1_BIT_ALL                      ((uint8_t)0xFF)
...
#define GPIO_PJ_FR2_BIT_ALL                      ((uint8_t)0x80)
#define GPIO_PJ_FR3_BIT_ALL                      ((uint8_t)0xC0)

#define GPIO_PK_OUTPUT_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PK_PULLUP_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PK_INPUT_BIT_ALL                    ((uint8_t)0x0F)
#define GPIO_PK_FR2_BIT_ALL                      ((uint8_t)0x03)
#define GPIO_PK_FR3_BIT_ALL                      ((uint8_t)0x0F)
...
#define IS_GPIO_PC_FR3_BIT(param)        (((param) & GPIO_PC_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PC_FR3_BIT_ALL))))

#define IS_GPIO_PC_FR4_BIT(param)        (((param) & GPIO_PC_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PC_FR4_BIT_ALL))))
...
#define IS_GPIO_PD_FR3_BIT(param)        (((param) & GPIO_PD_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PD_FR3_BIT_ALL))))
...
#define IS_GPIO_PG_FR5_BIT(param)        (((param) & GPIO_PG_FR5_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PG_FR5_BIT_ALL))))
...
#define IS_GPIO_PJ_FR2_BIT(param)        (((param) & GPIO_PJ_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PJ_FR2_BIT_ALL))))

#define IS_GPIO_PJ_FR3_BIT(param)        (((param) & GPIO_PJ_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PJ_FR3_BIT_ALL))))
