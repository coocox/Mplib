...
#ifndef __TMPM366_CG_H
#define __TMPM366_CG_H
...
#define IS_CG_PHIT0_SRC(param)        (((param) == CG_PHIT0_SRC_FGEAR) || \
    ...
    typedef enum {
        CG_USB_SRC_CLK_PLL = 0U,
        CG_USB_SRC_CLK_EXT = 1U,
    } CG_USBSrc;
#define IS_CG_USB_SRC(param)          (((param) == CG_USB_SRC_CLK_PLL) || \
                                       ((param) == CG_USB_SRC_CLK_EXT))
    ...
    typedef enum {
        ...
        CG_INT_SRC_8 = 8U,
        CG_INT_SRC_9 = 9U,
        CG_INT_SRC_USB_PON = 10U,
        CG_INT_SRC_USB_WKUP = 11U,
    } CG_INTSrc;
#define IS_CG_INT_SRC(param)          (((param) == CG_INT_SRC_0) || \
                                       ...
                                       ((param) == CG_INT_SRC_8) || \
                                       ((param) == CG_INT_SRC_9) || \
                                       ((param) == CG_INT_SRC_USB_PON) || \
                                       ((param) == CG_INT_SRC_USB_WKUP))
