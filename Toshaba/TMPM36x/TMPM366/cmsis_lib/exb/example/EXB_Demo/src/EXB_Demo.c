...
void EXB_GPIOConfig(void)
{
    ...
    GPIO_SetOutputEnableReg(GPIO_PD, 0x0F, ENABLE);
    GPIO_EnableFuncReg(GPIO_PD, GPIO_FUNC_REG_2, 0x0F);
    GPIO_SetInputEnableReg(GPIO_PD, 0x0F, ENABLE);

    GPIO_SetOutputEnableReg(GPIO_PE, 0x0F, ENABLE);
    GPIO_EnableFuncReg(GPIO_PE, GPIO_FUNC_REG_5, GPIO_PE_FR5_BIT_ALL);
    GPIO_SetInputEnableReg(GPIO_PE, 0x0F, ENABLE);
