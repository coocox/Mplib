...
/**
  ...
  *   TSB_TB8, TSB_TB9, TSB_TBA, TSB_TBB, TSB_TBC, TSB_TBD, TSB_TBE, TSB_TBF.
  * @retval None
  */
...
/**
  ...
  *    TMRB_CAPTURE_IN0_RISING_IN1_FALLING, TMRB_CAPTURE_OUTPUT_EDGE.
  * @retval None
  */
void TMRB_SetCaptureTiming(TSB_TB_TypeDef * TBx, uint32_t CaptureTiming)
{
    ...
    /* Check the parameters */
    assert_param(IS_TMRB_CAPTURE_SYNC_PERIPH(TBx));
