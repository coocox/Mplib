...
#ifndef __TMPM363_RMC_H
#define __TMPM363_RMC_H
...
/** @addtogroup RMC_Exported_Types
  * @{
  */
#if defined(__TMPM360_RMC_H) || defined(__TMPM362_RMC_H) || defined(__TMPM364_RMC_H)
#define IS_RMC_PERIPH(PERIPH)  (((PERIPH) == TSB_RMC0) || \
                                ((PERIPH) == TSB_RMC1))
#endif                          /* (__TMPM360_RMC_H) || (__TMPM362_RMC_H) || (__TMPM364_RMC_H) */
#if defined(__TMPM361_RMC_H) || defined(__TMPM363_RMC_H)
#define IS_RMC_PERIPH(PERIPH)  (((PERIPH) == TSB_RMC0))
#endif                          /* (__TMPM361_RMC_H) || (__TMPM363_RMC_H) || */
    typedef enum {
