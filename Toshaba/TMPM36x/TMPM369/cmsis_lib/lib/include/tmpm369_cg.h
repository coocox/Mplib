...
#ifndef __TMPM369_CG_H
#define __TMPM369_CG_H
...
#define IS_CG_PHIT0_SRC(param)  (((param) == CG_PHIT0_SRC_FGEAR) || \
    ...
    typedef enum {
        ...
        CG_INT_SRC_A = 10U,
        CG_INT_SRC_B = 11U,
        CG_INT_SRC_USBWKUP = 12U,
        CG_INT_SRC_USBDPON = 13U,
        CG_INT_SRC_RTC = 14U,
...
#define IS_CG_INT_SRC(param)    (((param) == CG_INT_SRC_0) || \
                                 ...
                                 ((param) == CG_INT_SRC_A) || \
                                 ((param) == CG_INT_SRC_B) || \
                                 ((param) == CG_INT_SRC_USBWKUP) || \
                                 ((param) == CG_INT_SRC_USBDPON) || \
...
#define CG_USBD_CLK_SUPPLY                   ((uint32_t)0xFFFFFFFE)
#define CG_USBH_CLK_SUPPLY                   ((uint32_t)0xFFFFFFFD)
#define CG_CAN_CLK_SUPPLY                    ((uint32_t)0xFFFFFFFB)
#define CG_ETHER_MAC_CLK_SUPPLY              ((uint32_t)0xFFFFFFF7)
                                             
#define IS_CG_PERIPH_CLK_SUPPLY(param)       (((param) == CG_USBD_CLK_SUPPLY) || \
                                              ((param) == CG_USBH_CLK_SUPPLY) || \
                                              ((param) == CG_CAN_CLK_SUPPLY) || \
                                              ((param) == CG_ETHER_MAC_CLK_SUPPLY))
