...
#ifndef __TMPM369_GPIO_H
#define __TMPM369_GPIO_H
...
#define IS_GPIO_PA_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_1)|| \
                                         ...
                                         ((param) == GPIO_FUNC_REG_4)|| \
                                         ((param) == GPIO_FUNC_REG_5))
...
#define GPIO_PA_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PA_FR3_BIT_ALL                      ((uint8_t)0xE8)
#define GPIO_PA_FR4_BIT_ALL                      ((uint8_t)0x80)
#define GPIO_PA_FR5_BIT_ALL                      ((uint8_t)0x80)

#define GPIO_PB_OUTPUT_BIT_ALL                   ((uint8_t)0x7F)
#define GPIO_PB_PULLUP_BIT_ALL                   ((uint8_t)0x7F)
#define GPIO_PB_PULLDOWN_BIT_ALL                 ((uint8_t)0x7F)
#define GPIO_PB_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x7F)
#define GPIO_PB_INPUT_BIT_ALL                    ((uint8_t)0x7F)
#define GPIO_PB_FR1_BIT_ALL                      ((uint8_t)0x7F)
#define GPIO_PB_FR2_BIT_ALL                      ((uint8_t)0x7C)
#define GPIO_PB_FR3_BIT_ALL                      ((uint8_t)0x3F)
#define GPIO_PB_FR4_BIT_ALL                      ((uint8_t)0x7C)
...
#define GPIO_PC_FR2_BIT_ALL                      ((uint8_t)0x03)

#define GPIO_PD_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PD_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PD_PULLDOWN_BIT_ALL                 ((uint8_t)0xFF)
#define GPIO_PD_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xFF)
#define GPIO_PD_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PD_FR1_BIT_ALL                      ((uint8_t)0xFF)
...
#define GPIO_PE_FR1_BIT_ALL                      ((uint8_t)0x7E)
#define GPIO_PE_FR2_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PE_FR3_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PE_FR4_BIT_ALL                      ((uint8_t)0x9B)
#define GPIO_PE_FR5_BIT_ALL                      ((uint8_t)0x9F)

#define GPIO_PF_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PF_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PF_PULLDOWN_BIT_ALL                 ((uint8_t)0xFF)
#define GPIO_PF_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xFF)
#define GPIO_PF_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PF_FR1_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PF_FR2_BIT_ALL                      ((uint8_t)0xF0)
#define GPIO_PF_FR3_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PF_FR4_BIT_ALL                      ((uint8_t)0xE6)
...
#define GPIO_PG_FR2_BIT_ALL                      ((uint8_t)0xFE)
#define GPIO_PG_FR3_BIT_ALL                      ((uint8_t)0xFF)
#define GPIO_PG_FR4_BIT_ALL                      ((uint8_t)0x0C)
...
#define GPIO_PH_FR1_BIT_ALL                      ((uint8_t)0xEF)
#define GPIO_PH_FR2_BIT_ALL                      ((uint8_t)0xAF)
#define GPIO_PH_FR3_BIT_ALL                      ((uint8_t)0x0F)
#define GPIO_PH_FR4_BIT_ALL                      ((uint8_t)0x0C)
#define GPIO_PH_FR5_BIT_ALL                      ((uint8_t)0x1F)

#define GPIO_PI_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PI_PULLDOWN_BIT_ALL                 ((uint8_t)0xFF)
#define GPIO_PI_OPEN_DRAIN_BIT_ALL               ((uint8_t)0xFF)
#define GPIO_PI_INPUT_BIT_ALL                    ((uint8_t)0xFF)
#define GPIO_PI_FR1_BIT_ALL                      ((uint8_t)0x0F)
#define GPIO_PI_FR2_BIT_ALL                      ((uint8_t)0x08)
...
#define GPIO_PK_OUTPUT_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PK_PULLUP_BIT_ALL                   ((uint8_t)0x1F)
#define GPIO_PK_PULLDOWN_BIT_ALL                 ((uint8_t)0x1F)
#define GPIO_PK_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x1F)
#define GPIO_PK_INPUT_BIT_ALL                    ((uint8_t)0x1F)
#define GPIO_PK_FR1_BIT_ALL                      ((uint8_t)0x1F)
#define GPIO_PK_FR2_BIT_ALL                      ((uint8_t)0x1E)
#define GPIO_PK_FR3_BIT_ALL                      ((uint8_t)0x1E)
#define GPIO_PK_FR4_BIT_ALL                      ((uint8_t)0x02)

#define GPIO_PL_OUTPUT_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PL_PULLUP_BIT_ALL                   ((uint8_t)0xFF)
#define GPIO_PL_PULLDOWN_BIT_ALL                 ((uint8_t)0xFF)
...
#define GPIO_PL_FR3_BIT_ALL                      ((uint8_t)0x0F)
#define GPIO_PL_FR4_BIT_ALL                      ((uint8_t)0x0F)
#define GPIO_PL_FR5_BIT_ALL                      ((uint8_t)0x0E)
#define GPIO_PL_FR6_BIT_ALL                      ((uint8_t)0x08)

#define GPIO_PM_OUTPUT_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PM_PULLUP_BIT_ALL                   ((uint8_t)0x0F)
#define GPIO_PM_PULLDOWN_BIT_ALL                 ((uint8_t)0x0F)
#define GPIO_PM_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x0F)
#define GPIO_PM_INPUT_BIT_ALL                    ((uint8_t)0x0F)
#define GPIO_PM_FR1_BIT_ALL                      ((uint8_t)0x07)
#define GPIO_PM_FR2_BIT_ALL                      ((uint8_t)0x0F)

#define GPIO_PN_OUTPUT_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PN_PULLUP_BIT_ALL                   ((uint8_t)0x3F)
#define GPIO_PN_PULLDOWN_BIT_ALL                 ((uint8_t)0x3F)
#define GPIO_PN_OPEN_DRAIN_BIT_ALL               ((uint8_t)0x3F)
#define GPIO_PN_INPUT_BIT_ALL                    ((uint8_t)0x3F)
#define GPIO_PN_FR1_BIT_ALL                      ((uint8_t)0x3F)
#define GPIO_PN_FR2_BIT_ALL                      ((uint8_t)0x30)
...
#define IS_GPIO_PA_FR3_BIT(param)        (((param) & GPIO_PA_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PA_FR3_BIT_ALL))))

#define IS_GPIO_PA_FR4_BIT(param)        (((param) & GPIO_PA_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PA_FR4_BIT_ALL))))

#define IS_GPIO_PA_FR5_BIT(param)        (((param) & GPIO_PA_FR5_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PA_FR5_BIT_ALL))))
...
#define IS_GPIO_PB_FR2_BIT(param)        (((param) & GPIO_PB_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PB_FR2_BIT_ALL))))

#define IS_GPIO_PB_FR3_BIT(param)        (((param) & GPIO_PB_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PB_FR3_BIT_ALL))))

#define IS_GPIO_PB_FR4_BIT(param)        (((param) & GPIO_PB_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PB_FR4_BIT_ALL))))
...
#define IS_GPIO_PC_FR2_BIT(param)        (((param) & GPIO_PC_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PC_FR2_BIT_ALL))))
...
#define IS_GPIO_PE_FR3_BIT(param)        (((param) & GPIO_PE_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PE_FR3_BIT_ALL))))

#define IS_GPIO_PE_FR4_BIT(param)        (((param) & GPIO_PE_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PE_FR4_BIT_ALL))))

#define IS_GPIO_PE_FR5_BIT(param)        (((param) & GPIO_PE_FR5_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PE_FR5_BIT_ALL))))
...
#define IS_GPIO_PF_FR4_BIT(param)        (((param) & GPIO_PF_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PF_FR4_BIT_ALL))))
...
#define IS_GPIO_PG_FR2_BIT(param)        (((param) & GPIO_PG_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PG_FR2_BIT_ALL))))

#define IS_GPIO_PG_FR3_BIT(param)        (((param) & GPIO_PG_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PG_FR3_BIT_ALL))))

#define IS_GPIO_PG_FR4_BIT(param)        (((param) & GPIO_PG_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PG_FR4_BIT_ALL))))
...
#define IS_GPIO_PH_FR2_BIT(param)        (((param) & GPIO_PH_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PH_FR2_BIT_ALL))))

#define IS_GPIO_PH_FR3_BIT(param)        (((param) & GPIO_PH_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PH_FR3_BIT_ALL))))

#define IS_GPIO_PH_FR4_BIT(param)        (((param) & GPIO_PH_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PH_FR4_BIT_ALL))))

#define IS_GPIO_PH_FR5_BIT(param)        (((param) & GPIO_PH_FR5_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PH_FR5_BIT_ALL))))
...
#define IS_GPIO_PI_FR1_BIT(param)        (((param) & GPIO_PI_FR1_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PI_FR1_BIT_ALL))))

#define IS_GPIO_PI_FR2_BIT(param)        (((param) & GPIO_PI_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PI_FR2_BIT_ALL))))
...
#define IS_GPIO_PK_FR2_BIT(param)        (((param) & GPIO_PK_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PK_FR2_BIT_ALL))))

#define IS_GPIO_PK_FR3_BIT(param)        (((param) & GPIO_PK_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PK_FR3_BIT_ALL))))

#define IS_GPIO_PK_FR4_BIT(param)        (((param) & GPIO_PK_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PK_FR4_BIT_ALL))))
...
#define IS_GPIO_PL_OUTPUT_BIT(param)     (((param) & GPIO_PL_OUTPUT_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_OUTPUT_BIT_ALL))))
...
#define IS_GPIO_PL_FR2_BIT(param)        (((param) & GPIO_PL_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_FR2_BIT_ALL))))

#define IS_GPIO_PL_FR3_BIT(param)        (((param) & GPIO_PL_FR3_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_FR3_BIT_ALL))))

#define IS_GPIO_PL_FR4_BIT(param)        (((param) & GPIO_PL_FR4_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_FR4_BIT_ALL))))

#define IS_GPIO_PL_FR5_BIT(param)        (((param) & GPIO_PL_FR5_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_FR5_BIT_ALL))))

#define IS_GPIO_PL_FR6_BIT(param)        (((param) & GPIO_PL_FR6_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_FR6_BIT_ALL))))

#define IS_GPIO_PL_OPEN_DRAIN_BIT(param) (((param) & GPIO_PL_OPEN_DRAIN_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_OPEN_DRAIN_BIT_ALL))))

#define IS_GPIO_PL_PULLUP_BIT(param)     (((param) & GPIO_PL_PULLUP_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_PULLUP_BIT_ALL))))

#define IS_GPIO_PL_INPUT_BIT(param)      (((param) & GPIO_PL_INPUT_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_INPUT_BIT_ALL))))

#define IS_GPIO_PL_PULLDOWN_BIT(param)   (((param) & GPIO_PL_PULLDOWN_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PL_PULLDOWN_BIT_ALL))))
...
#define IS_GPIO_PM_FR1_BIT(param)        (((param) & GPIO_PM_FR1_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PM_FR1_BIT_ALL))))

#define IS_GPIO_PM_FR2_BIT(param)        (((param) & GPIO_PM_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PM_FR2_BIT_ALL))))
...
#define IS_GPIO_PN_FR2_BIT(param)        (((param) & GPIO_PN_FR2_BIT_ALL)&& \
                                          (!((param) &(uint8_t) (~GPIO_PN_FR2_BIT_ALL))))
