...
#ifndef __TMPM369_FUART_H
#define __TMPM369_FUART_H
...
#define IS_FUART_DIRECTION(param)              (((param) == FUART_RX) || \
    ...
    typedef union {
        uint32_t All;
        struct {
            uint32_t Reserved1:8;              /* bit 0~7 */
            uint32_t FramingErr:1;             /* bit 8 */
            uint32_t ParityErr:1;              /* bit 9 */
            uint32_t BreakErr:1;               /* bit 10 */
            uint32_t OverrunErr:1;             /* bit 11 */
            uint32_t Reserved2:20;             /* bit 12~31 */
        } Bit;
    } FUART_Err;
...
#endif                          /* defined(__TMPM369_FUART_H) */

#ifdef __cplusplus
}
#endif
#endif                          /* __TMPM369_FUART_H */
