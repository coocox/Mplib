...
/**
  ...
  *   This parameter can be one of the following values:
  *   FUART4, FUART5.
  * @retval The union that indicates Full UART receive error status.
  */
FUART_Err FUART_GetErrStatus(TSB_FUART_TypeDef * FUARTx)
{
    ...
    /* Read the receive error status information from UARTDR register */
    retval.All = FUARTx->RSR;
    return retval;
}
