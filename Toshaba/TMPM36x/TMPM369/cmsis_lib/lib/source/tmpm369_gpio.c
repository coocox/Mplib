...
void GPIO_SetPullDown(GPIO_Port GPIO_x, uint8_t Bit_x, FunctionalState NewState)
{
    ...
    if (Bit_x == GPIO_BIT_ALL) {
        ...
        case GPIO_PK:
            ...
            break;
        case GPIO_PL:
            Bit_x = GPIO_PL_PULLDOWN_BIT_ALL;
            break;
        case GPIO_PM:
    ...
    case GPIO_PL:
        /* Check the parameters */
        assert_param(IS_GPIO_PL_PULLDOWN_BIT(Bit_x));
        if (NewState == ENABLE) {
            TSB_PL->PDN |= Bit_x;
        } else {
            tmp = (~Bit_x);
...
/**
  ...
  *   GPIO_PA, GPIO_PB, GPIO_PC, GPIO_PD,
  *   GPIO_PE, GPIO_PF, GPIO_PG, GPIO_PH,
  *   GPIO_PI, GPIO_PK, GPIO_PL, GPIO_PM,
  *   GPIO_PN.
...
void GPIO_EnableFuncReg(GPIO_Port GPIO_x, uint8_t FuncReg_x, uint8_t Bit_x)
{
    ...
    case GPIO_PA:
        ...
        case GPIO_FUNC_REG_3:
            /* Check the parameters */
            assert_param(IS_GPIO_PA_FR3_BIT(Bit_x));
            TSB_PA->FR3 |= Bit_x;
            break;
        case GPIO_FUNC_REG_4:
            /* Check the parameters */
            assert_param(IS_GPIO_PA_FR4_BIT(Bit_x));
            TSB_PA->FR4 |= Bit_x;
            break;
        case GPIO_FUNC_REG_5:
            /* Check the parameters */
            assert_param(IS_GPIO_PA_FR5_BIT(Bit_x));
            TSB_PA->FR5 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PB:
        ...
        case GPIO_FUNC_REG_3:
            /* Check the parameters */
            assert_param(IS_GPIO_PB_FR3_BIT(Bit_x));
            TSB_PB->FR3 |= Bit_x;
            break;
        case GPIO_FUNC_REG_4:
            /* Check the parameters */
            assert_param(IS_GPIO_PB_FR4_BIT(Bit_x));
            TSB_PB->FR4 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PE:
        ...
        case GPIO_FUNC_REG_5:
            /* Check the parameters */
            assert_param(IS_GPIO_PE_FR5_BIT(Bit_x));
            TSB_PE->FR5 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PF:
        ...
        case GPIO_FUNC_REG_4:
            /* Check the parameters */
            assert_param(IS_GPIO_PF_FR4_BIT(Bit_x));
            TSB_PF->FR4 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PH:
        ...
        case GPIO_FUNC_REG_5:
            /* Check the parameters */
            assert_param(IS_GPIO_PH_FR5_BIT(Bit_x));
            TSB_PH->FR5 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PI:
        ...
        case GPIO_FUNC_REG_2:
            /* Check the parameters */
            assert_param(IS_GPIO_PI_FR2_BIT(Bit_x));
            TSB_PI->FR2 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PK:
        ...
        case GPIO_FUNC_REG_4:
            /* Check the parameters */
            assert_param(IS_GPIO_PK_FR4_BIT(Bit_x));
            TSB_PK->FR4 |= Bit_x;
            break;
        default:
            /* Do nothing */
    ...
    case GPIO_PL:
        ...
        case GPIO_FUNC_REG_4:
            /* Check the parameters */
            assert_param(IS_GPIO_PL_FR4_BIT(Bit_x));
            TSB_PL->FR4 |= Bit_x;
            break;
        case GPIO_FUNC_REG_5:
            /* Check the parameters */
            assert_param(IS_GPIO_PL_FR5_BIT(Bit_x));
            TSB_PL->FR5 |= Bit_x;
            break;
        case GPIO_FUNC_REG_6:
            /* Check the parameters */
            assert_param(IS_GPIO_PL_FR6_BIT(Bit_x));
            TSB_PL->FR6 |= Bit_x;
            break;
        default:
            /* Do nothing */
