...
#define CG_FPLL_8M_MULTIPLY_6_VALUE          ((uint32_t)0x0000B22E)
#define CG_FPLL_8M_MULTIPLY_10_VALUE         ((uint32_t)0x0000B34C)
#define CG_FPLL_10M_MULTIPLY_8_VALUE         ((uint32_t)0x0000E53C)
#define CG_FPLL_12M_MULTIPLY_4_VALUE         ((uint32_t)0x0000B41E)
#define CG_FPLL_12M_MULTIPLY_6_VALUE         ((uint32_t)0x0000C52C)
#define CG_FPLL_16M_MULTIPLY_3_VALUE         ((uint32_t)0x0000E416)
#define CG_FPLL_16M_MULTIPLY_5_VALUE         ((uint32_t)0x00007524)
...
Result CG_SetFPLLValue(CG_FpllValue NewValue)
{
    ...
    if (pllon == ENABLE) {
        ...
        switch (NewValue) {
        case CG_FPLL_8M_MULTIPLY_6:
        	TSB_CG->PLLSEL = CG_FPLL_8M_MULTIPLY_6_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_8M_MULTIPLY_10:
        	TSB_CG->PLLSEL = CG_FPLL_8M_MULTIPLY_10_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_10M_MULTIPLY_8:
        	TSB_CG->PLLSEL = CG_FPLL_10M_MULTIPLY_8_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_12M_MULTIPLY_4:
        	TSB_CG->PLLSEL = CG_FPLL_12M_MULTIPLY_4_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_12M_MULTIPLY_6:
        	TSB_CG->PLLSEL = CG_FPLL_12M_MULTIPLY_6_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_16M_MULTIPLY_3:
        	TSB_CG->PLLSEL = CG_FPLL_16M_MULTIPLY_3_VALUE;
        	retval = SUCCESS;
        	break;
        case CG_FPLL_16M_MULTIPLY_5:
        	TSB_CG->PLLSEL = CG_FPLL_16M_MULTIPLY_5_VALUE;
        	retval = SUCCESS;
        	break;
        default:
          /* Do nothing */
...
/**
  ...
  *   The value returned can be one of the following values:
  *   CG_FPLL_MULTIPLY_8 ,  CG_FPLL_MULTIPLY_6 or
...
CG_FpllValue CG_GetFPLLValue(void)
{
    ...
    switch (pllsel) {
    case CG_FPLL_8M_MULTIPLY_6_VALUE:
        retval = CG_FPLL_8M_MULTIPLY_6;
        break;
    case CG_FPLL_8M_MULTIPLY_10_VALUE:
        retval = CG_FPLL_8M_MULTIPLY_10;
        break;
    case CG_FPLL_10M_MULTIPLY_8_VALUE:
        retval = CG_FPLL_10M_MULTIPLY_8;
        break;
    case CG_FPLL_12M_MULTIPLY_4_VALUE:
        retval = CG_FPLL_12M_MULTIPLY_4;
        break;
    case CG_FPLL_12M_MULTIPLY_6_VALUE:
        retval = CG_FPLL_12M_MULTIPLY_6;
        break;
    case CG_FPLL_16M_MULTIPLY_3_VALUE:
        retval = CG_FPLL_16M_MULTIPLY_3;
        break;
    case CG_FPLL_16M_MULTIPLY_5_VALUE:
        retval = CG_FPLL_16M_MULTIPLY_5;
        break;
    default:
        /* Do nothing */
        break;
...
/**
  ...
  *   CG_INT_SRC_USBWKUP, CG_INT_SRC_USBDPON,
...
/**
  * @brief  Disable supplying fc for USBD, USBH, CAN and EtherMac.
  * @param  Periph: The target peripheral that CG supplies fc for
  *   This parameter can be one of the following values:
  *   CG_USBD_CLK_SUPPLY: USBD clock control
  *   CG_USBH_CLK_SUPPLY: USBH clock control
  *   CG_CAN_CLK_SUPPLY: CAN clock control
  *   CG_ETHER_MAC_CLK_SUPPLY: EtherMac clock control
  * @retval None
  */
void CG_DisablePeriphClkSupply(uint32_t Periph)
{
    /* Check the parameters */
    assert_param(IS_CG_PERIPH_CLK_SUPPLY(Periph));
    
    TSB_CG->PCKSTP &= Periph;
}

/**
  * @brief  Enable or disable low-speed oscillator (fs) for RMC & OFD
  * @param  NewState: oscillator is enabled or disabled
  *   This parameter can be one of the following values:
  *   DISABLE or ENABLE
  * @retval None
