...
1)Open Keil uVision, connect ULink with PC and TOSHIBA M369 Evaluation Board, then click menu: Project->Open project, choose 
...
8)Press RESET button while SW0 is turned on, and release SW0 until LCD displays "User Boot Mode".
