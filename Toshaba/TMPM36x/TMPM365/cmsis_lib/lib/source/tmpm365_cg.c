...
#define CG_RESET_FLAG_MASK          ((uint32_t)0xFFFFFFEA)
...
/**
  ...
  *   The value returned can be one of the following values:
  *   CG_FPLL_MULTIPLY_8 , CG_FPLL_MULTIPLY_UNKNOWN
  */
CG_FpllValue CG_GetFPLLValue(void)
{
    ...
    if (pllsel == FPLL_MULTIPLY_8_VALUE) {
