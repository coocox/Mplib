...
#define DMACA_SOFTBREQ_MASK          ((uint32_t)0x0000FFFF)
...
/**
  ...
  *   DMACA_TMRB4_CAPTURE1, DMACA_TMRB5_CAPTURE0, DMACA_TMRB5_CAPTURE1, DMACA_NORMAL_ADC,
  *   DMACA_I2C0_SIO0_RX, DMACA_I2C0_SIO0_TX,DMACA_I2C1_SIO1_RX,DMACA_I2C1_SIO1_TX
  * @retval None
  */
