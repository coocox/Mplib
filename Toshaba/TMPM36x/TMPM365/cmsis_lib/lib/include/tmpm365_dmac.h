...
#ifndef __TMPM365_DMAC_H
#define __TMPM365_DMAC_H
...
#define IS_DMAC_BURST_SIZE(param)  (((param) == DMAC_1_BEAT) || \
    ...
    typedef enum {
        ...
        DMACA_NORMAL_ADC = 11U,
        DMACA_I2C0_SIO0_RX = 12U,
        DMACA_I2C0_SIO0_TX = 13U,
        DMACA_I2C1_SIO1_RX = 14U,
        DMACA_I2C1_SIO1_TX = 15U
    } DMACA_ReqNum;
...
#define IS_DMACA_REQ_NUM(param)  (((param) == DMACA_SIO0_UART0_RX) || \
                                   ...
                                   ((param) == DMACA_NORMAL_ADC) || \
                                   ((param) == DMACA_I2C0_SIO0_RX) || \
                                   ((param) == DMACA_I2C0_SIO0_TX) || \
                                   ((param) == DMACA_I2C1_SIO1_RX) || \
                                   ((param) == DMACA_I2C1_SIO1_TX))
...
#define IS_DMACA_BURST_REQ_NUM(param)  (((param) == DMACA_SIO0_UART0_RX) || \
    ...
    typedef union {
        ...
        struct {
            ...
            uint32_t I2C0_SIO0_RX:1;
            uint32_t I2C0_SIO0_TX:1;
            uint32_t I2C1_SIO1_RX:1;
            uint32_t I2C1_SIO1_TX:1;
        } Bit_A;
    } DMAC_BurstReqState;
...
#endif                          /* defined(__TMPM365_DMAC_H) */

#ifdef __cplusplus
}
#endif
#endif                          /* __TMPM365_DMAC_H */
