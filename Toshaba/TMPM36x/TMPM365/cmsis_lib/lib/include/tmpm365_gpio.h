...
#ifndef __TMPM365_GPIO_H
#define __TMPM365_GPIO_H
...
#define IS_GPIO_FUNCTION(param)         (((param) == GPIO_PC)|| \
                                         ((param) == GPIO_PD)|| \
                                         ((param) == GPIO_PE)|| \
                                         ((param) == GPIO_PF)|| \
                                         ((param) == GPIO_PG)|| \
...
#define IS_GPIO_PD_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_3))

#define IS_GPIO_PE_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_1)|| \
                                         ((param) == GPIO_FUNC_REG_3)|| \
                                         ((param) == GPIO_FUNC_REG_4))

#define IS_GPIO_PF_FUNCTION_REG(param)  (((param) == GPIO_FUNC_REG_2)|| \
                                         ((param) == GPIO_FUNC_REG_3))
...
#define GPIO_PG_FR4_BIT_ALL                      ((uint8_t)0x20)
...
#define GPIO_PI_PULLUP_BIT_ALL                   ((uint8_t)0xF7)
