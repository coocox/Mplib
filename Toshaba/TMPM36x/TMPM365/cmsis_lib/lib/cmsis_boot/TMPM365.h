...
#ifndef __TMPM365_H__
#define __TMPM365_H__
...
/******  TMPM365 Specific Interrupt Numbers *******************************************************************/
  ...
  INTABTLOSS0_IRQn              = 61,        /*!< I2C arbitration lost interrupt 0                            */
  INTDMAC0ERR_IRQn              = 62,        /*!< DMA error status interrupt 0                                */
  INTABTLOSS1_IRQn              = 63         /*!< I2C arbitration lost interrupt 1                            */
} IRQn_Type;
...
#include "system_TMPM365.h"                 /* TMPM365 System                                      */
...
/* DMA Controller */
#define TSB_DMACA_INTSTATUS0                      (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTSTATUS,0)))
#define TSB_DMACA_INTSTATUS1                      (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTSTATUS,1)))
#define TSB_DMACA_INTTCSTATUS0                    (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTTCSTATUS,0)))
#define TSB_DMACA_INTTCSTATUS1                    (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTTCSTATUS,1)))
#define TSB_DMACA_INTERRSTATUS0                   (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTERRORSTATUS,0)))
#define TSB_DMACA_INTERRSTATUS11                  (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->INTERRORSTATUS,1)))
#define TSB_DMACA_RAWINTTCSTATUS0                 (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->RAWINTTCSTATUS,0)))
#define TSB_DMACA_RAWINTTCSTATUS1                 (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->RAWINTTCSTATUS,1)))
#define TSB_DMACA_RAWINTERRSTATUS0                (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->RAWINTERRORSTATUS,0)))
#define TSB_DMACA_RAWINTERRSTATUS1                (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->RAWINTERRORSTATUS,1)))
...
#define TSB_DMACA_C0CONFIG_ACTIVE                 (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->C0CONFIGURATION,17)))
#define TSB_DMACA_C1CONFIG_ACTIVE                 (*((__I  uint32_t *)BITBAND_PERI(&TSB_DMACA->C1CONFIGURATION,17)))
...
#define TSB_TB0_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB0->CR,4)))
...
#define TSB_TB1_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB1->CR,4)))
...
#define TSB_TB2_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB2->CR,4)))
...
#define TSB_TB3_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB3->CR,4)))
...
#define TSB_TB4_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB4->CR,4)))
...
#define TSB_TB5_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB5->CR,4)))
...
#define TSB_TB6_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB6->CR,4)))
...
#define TSB_TB7_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB7->CR,4)))
...
#define TSB_TB8_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB8->CR,4)))
...
#define TSB_TB9_CR_FT0SEL                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB9->CR,4)))
