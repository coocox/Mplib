...
int SPI_Flash(void)
{
    ...
    printf("\n+------------------------------------------------------------------------+\n");
    printf("|            NUC400 Series SPI Sample with SPI Flash                     |\n");
    printf("+------------------------------------------------------------------------+\n");
...
void SYS_Init(void)
{
    ...
    SYS->GPH_MFPH = (SYS_GPH_MFPH_PH8_MFP_SPI2_MOSI0 | SYS_GPH_MFPH_PH9_MFP_SPI2_MISO1 | SYS_GPH_MFPH_PH10_MFP_SPI2_MOSI1);
