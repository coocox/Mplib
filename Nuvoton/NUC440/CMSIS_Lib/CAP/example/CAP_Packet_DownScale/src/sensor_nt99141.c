...
static struct NT_RegValue g_sNT99141_VGA_RegValue[]= {
    ...
    {0x3201, 0x0F},{0x3028, 0x07},{0x3029, 0x00},{0x302A, 0x04},{0x3022, 0x25},
...
int InitNT99141_VGA_YUV422(void)
{
    ...
    SYS->GPH_MFPL &= ~SYS_GPH_MFPL_PH3_MFP_Msk;        /* GPH3 for GPIO to act as SCK */
    SYS->GPH_MFPL &= ~SYS_GPH_MFPL_PH4_MFP_Msk;        /* GPH4 for GPIO to act as SDA */

    /* switch I2C pin function, to do... */
    SWI2C_Open(eDRVGPIO_GPIOH,eDRVGPIO_PIN3,eDRVGPIO_GPIOH,eDRVGPIO_PIN4,Delay);
