 ...
 * @brief    NUC400 series CAN driver source file
 *
 * @note
...
/**
  * @brief    1. The function is used to set bus timing parameter according current clock and target baud-rate. \n
  *           2. Set CAN operation mode.
  *
  * @param    tCAN        The base address of can module
  * @param    u32BaudRate The target CAN baud-rate. The range of u32BaudRate is 1~1000KHz
...
/**
  ...
  *
  * @param    tCAN       The base address of can module.
  * @param    u32Mask    Interrupt Mask. (CAN_CON_IE_Msk / CAN_CON_SIE_Msk / CAN_CON_SIE_Msk)
  *
  * @return   None
  */
...
{
    if((tCAN->CON & CAN_CON_TEST_Msk) && (tCAN->TEST & CAN_TEST_LBACK_Msk)) {
