 ...
 * @brief    NUC400 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
/** @addtogroup NUC400_SCUART_Driver SCUART Driver
  @{
*/

/** @addtogroup NUC400_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC400_SCUART_EXPORTED_CONSTANTS */


/** @addtogroup NUC400_SCUART_EXPORTED_FUNCTIONS SCUART Exported Functions
  @{
*/
...
/**
  ...
  * @retval SC_SR_TX_EMPTY_F_Msk Transmit FIFO is empty
  * \hideinitializer
  */
#define SCUART_GET_TX_EMPTY(sc) ((sc)->SR & SC_SR_TX_EMPTY_F_Msk)
...
/**
  ...
  * @retval SC_SR_TX_FULL_F_Msk Transmit FIFO is full
  * \hideinitializer
  */
#define SCUART_GET_TX_FULL(sc) ((sc)->SR & SC_SR_TX_FULL_F_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_WAIT_TX_EMPTY(sc) while((sc)->SR & SC_SR_TX_ATV_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_TX_FULL(sc) ((sc)->SR & SC_SR_TX_FULL_F_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_TX_EMPTY(sc) ((sc)->SR & SC_SR_TX_ATV_Msk ? 0 : 1)
...
/**
  ...
  * @retval SC_SR_RX_EMPTY_F_Msk Receive FIFO is empty
  * \hideinitializer
  */
#define SCUART_GET_RX_EMPTY(sc) ((sc)->SR & SC_SR_RX_EMPTY_F_Msk)
...
/**
  ...
  * @retval SC_SR_RX_FULL_F_Msk Receive FIFO is full
  * \hideinitializer
  */
#define SCUART_GET_RX_FULL(sc) ((sc)->SR & SC_SR_RX_FULL_F_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_RX_FULL(sc) ((sc)->SR & SC_SR_RX_FULL_F_Msk ? 1 : 0)
...
/**
  ...
  * @retval SC_SR_RX_EPA_F_Msk Parity error
  * @retval SC_SR_RX_EFR_F_Msk Frame error
  * @retval SC_SR_RX_EBR_F_Msk Break error
  * \hideinitializer
  */
#define SCUART_GET_ERR_FLAG(sc) ((sc)->SR & (SC_SR_RX_EPA_F_Msk | SC_SR_RX_EFR_F_Msk | SC_SR_RX_EBR_F_Msk))
...
/**
  ...
  *             - \ref SC_SR_RX_EPA_F_Msk
  *             - \ref SC_SR_RX_EFR_F_Msk
  *             - \ref SC_SR_RX_EBR_F_Msk
  * @return None
  * \hideinitializer
  */
#define SCUART_CLR_ERR_FLAG(sc, u32Mask) ((sc)->SR = u32Mask)
...
/*@}*/ /* end of group NUC400_SCUART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC400_SCUART_Driver */
