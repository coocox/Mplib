 ...
 * $Revision: 4 $
 * $Date: 13/11/10 9:32a $
 * @brief    NUC400 Series Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup NUC400_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
...
#define FMC_FLASH_PAGE_SIZE     0x800           /*!< Flash Page Size (2 Kbytes)  */
#define FMC_LDROM_SIZE          0x4000          /*!< LDROM Size (16 Kbytes)      */

/*---------------------------------------------------------------------------------------------------------*/
/*  ISPCMD constant definitions                                                                            */
/*---------------------------------------------------------------------------------------------------------*/
#define FMC_ISPCMD_READ         0x00            /*!< ISP Command: Read flash word         */
#define FMC_ISPCMD_READ_64      0x40            /*!< ISP Command: Read flash double word  */
#define FMC_ISPCMD_WRITE        0x21            /*!< ISP Command: Write flash word        */
#define FMC_ISPCMD_WRITE_64     0x61            /*!< ISP Command: Write flash double word */
...
#define ISP_ISPCMD_MULTI_WRITE  0x27            /*!< ISP Command: Multiple program        */
...
/*@}*/ /* end of group NUC400_FMC_EXPORTED_CONSTANTS */
...
#define FMC_GET_FAIL_FLAG()         (FMC->ISPSTA & FMC_ISPSTA_ISPFF_Msk)        /*!< Get ISP fail flag          */
#define FMC_CLR_FAIL_FLAG()         (FMC->ISPSTA |= FMC_ISPSTA_ISPFF_Msk)       /*!< Clear ISP fail flag        */
