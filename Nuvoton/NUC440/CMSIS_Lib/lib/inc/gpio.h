 ...
 * $Revision: 7 $
 * $Date: 13/11/10 9:32a $
 * @brief    NUC400 series GPIO driver header file
 *
 * @note
...
/** @addtogroup NUC400_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC400_GPIO_EXPORTED_CONSTANTS */
 ...
 *
 * @param[in]   u32ClkSrc   The de-bounce counter clock source. It could be GPIO_DBNCECON_DBCLKSRC_HCLK or GPIO_DBNCECON_DBCLKSRC_IRC10K.
