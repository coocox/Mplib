 ...
 * $Revision: 3 $
 * $Date: 14/01/13 7:42p $
 * @brief    NUC400 series TIMER driver header file
 *
 * @note
...
/** @addtogroup NUC400_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
#define TIMER_TOGGLE_OUT1                   (TIMER_TCSR_OFFTOUT_2_Msk)      /*!< Select PB.4, PB.1, PC.6, PC.1 as timer toggle output pin  */
#define TIMER_TOGGLE_OUT2                   (TIMER_TCSR_OFFTOUT_1_Msk)      /*!< Select PD.1, PE.8, PE.1, PD.11 as timer toggle output pin */

/*@}*/ /* end of group NUC400_TIMER_EXPORTED_CONSTANTS */
...
/**
  ...
  * \hideinitializer
  */
#define TIMER_SELECT_TOUT_PIN(timer, u32ToutSel) ((timer)->TCSR = ((timer)->TCSR & ~(TIMER_TCSR_OFFTOUT_2_Msk | TIMER_TCSR_OFFTOUT_1_Msk)) | (u32ToutSel))
