/**************************************************************************//**
 * @file     system_NUC400Series.h
 * @version  V1.00
 * $Revision: 3 $
 * $Date: 13/11/10 9:32a $
 * @brief    NUC400 series system clock definition file
 *
 * @note
 * Copyright (C) 2013 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
#ifndef __SYSTEM_NUC400SERIES_H__
#define __SYSTEM_NUC400SERIES_H__
...
#endif /* __SYSTEM_NUC400SERIES_H__ */
